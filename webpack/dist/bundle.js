...
module.exports = JSON.parse('{"city":"kraków","name":"szymok","active":true,"numers":[1,2,3,4]}');
...
let a = 5;
let b = 8;
console.log("test", a + b, _math__WEBPACK_IMPORTED_MODULE_0__.default.area(a, b));
console.log(_data_test_json__WEBPACK_IMPORTED_MODULE_1__);
